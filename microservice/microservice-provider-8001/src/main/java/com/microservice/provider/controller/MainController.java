package com.microservice.provider.controller;
 ...
 import com.microservice.provider.service.DeptService;
...
public class MainController {
    ...
    public @ResponseBody Dept error(@PathVariable("id") Integer id){
        return new Dept(id,"cannot find this id","in database");
    }
